...
assert.match(shell, /async function initializeAuth\(\)\s*\{\s*prepareGoogleIdentityServicesRetry\(\);/,
  'every auth reinitialization must reset a timed-out Google script request');
